    ...
    <>
            ...
            <Col xs={12} xl={6} className='mb-24'>
              <Card bordered={false} className='widget-2 h-full'>
                <Statistic
                  title={
                    <>
                      <div className='icon'>{BillingAngle}</div>
                      <h6>Salary</h6>
        ...
        <Col span={24} md={8} className='mb-24'>
          ...
          >
            <List
              ...
              renderItem={(item) => (
                <List.Item
                  actions={[<Button type='link'>{BillingDownload} PDF</Button>]}
                >
                  <List.Item.Meta
                    title={item.title}
      ...
      <Row gutter={[24, 0]}>
        <Col span={24} md={16} className='mb-24'>
          ...
          >
            <Row gutter={[24, 24]}>
              {BillingInformation.map((i, index) => (
