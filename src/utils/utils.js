...
export const MedicaldataSource = [
  {
    key: "1",
    name: "Mike",
    age: 32,
...
export const MedicaldataColumns =
...
[
  
  {
    ...
    dataIndex: "name",
    key: "name",
    render: (text) => <a style={{ color: "#9370DB" }}>{text}</a>,
  },
  {
    title: "Age",
    dataIndex: "age",
    ...
    name: (
      <>
        <Avatar.Group>
          ...
          ></Avatar>
          <div className="avatar-info">
            <Title level={5}>Jhons Smelga</Title>
            <p>michael@mail.com</p>
          </div>
        </Avatar.Group>{" "}
      </>
    ...
    name: (
      <>
        <Avatar.Group>
          ...
          ></Avatar>
          <div className="avatar-info">
            <Title level={5}>Harwey Steve</Title>
            <p>michael@mail.com</p>
          </div>
        </Avatar.Group>{" "}
      </>
...
export const LiveScores = [
  ...
  {
    key: "3",
    playerName: "Shawn Mendes ",
    Score: "59",
    TeamScore: "559",
  },
  {
    key: "4",
    playerName: "Rional Messi ",
    Score: "69",
    TeamScore: "115",
  },
];
export const LiveScoresColuns = [
  {
    title: "Player name",
...
// HEADER LTR & RTL COMPONENT UTILS
...
export const HeaderData = [
  {
    ...
    description: <>{HeaderClockIcon} 2 days ago</>,
  ...
  },
  {
    ...
    avatar: <Avatar shape="square">{HeaderWifi}</Avatar>,
  },
  {
    title: "Payment completed",
    description: <>{HeaderClockIcon} 2 days ago</>,
    avatar: <Avatar shape="square">{HeaderCredit}</Avatar>,
  },
];
